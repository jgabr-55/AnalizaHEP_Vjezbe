...
// Tue Nov  5 10:13:57 2019 by ROOT version 6.18/04
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   TLorentzVector z1, z2, l1, l2, l3, l4, h;
   TH1F *weight_histo;
   TString fileName;
	TTree *tree;
	...
	TH1F *h5_qqzz;
	double D;
	TH1F *h6_kin_diskr_sig;
	TH1F *h6_kin_diskr_poz;
	virtual void PlotD();
	TH2F *masa_kin_sig;
	virtual void fitHiggs();
	virtual void fitHiggsAndZ();
	TF1 *bw_higgs,*bw_z, *polinom, *suma, *bw;
};
...
// used to generate this class and read the Tree.
   //tu je bio dio koda za otvaranje ggH125 filea (signali)-->ovo je konstruktor
	h5_higgs = new TH1F("Higgs","",50,70,170);
	h5_qqzz = new TH1F("qqZZ","",50,70,170);
	h6_kin_diskr_sig = new TH1F("signal","",10,0,1);
	h6_kin_diskr_poz = new TH1F("pozadina","",10,0,1);
	
	masa_kin_sig = new TH2F("mass_kin","",50,70,170,10,0,1);
